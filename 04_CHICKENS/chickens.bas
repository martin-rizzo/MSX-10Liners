...
170 S=400+N:FORI=0TO31:D(I)=S:C(I)=I*4+128:Q(I)=I<5ORI>26:NEXT:Q(0)=1:L=2:X=80:Y=X:Z=L*99:C=15
180 '
190 ' ====== GAME LOOP (4 LINES) ======
200 T=STICK(0)*2:X=X+J(T):Y=Y+J(T+1):I=ZAND15:D=D(I):VPOKED,7:PUTSPRITE0,(X,Y),C
210 E=N+(Y\8)*K+X\8+K:IFI<LTHEND=D+Q(IAND1)*J(18+RND(1)*5):VPOKED,C(I):D(I)=D
218 IFI<LANDQ(DAND31)THENCLS:PRINT"PTS:";P:ENDELSET=VPEEK(E)\4-K:C=15:Z=Z+1
220 IFT<0GOTO200ELSEVPOKEE,7:D(T)=S:L=Z\99:P=P+T:PLAY"A":C=3:LOCATE,0:PRINTP:GOTO200
