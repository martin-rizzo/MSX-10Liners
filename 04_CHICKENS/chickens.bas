...
126 SPRITE$(0)="p¨øp>}½½¹8|fffî":FORI=1032TO1160:VPOKEI,VPEEK(I-8):NEXT:PLAY"L64"
140 '
150 ' === INIT GAME LOOP (1 LINE) ===
170 S=N+400:FORI=0TO31:D(I)=S:Q(I)=I<3ORI>28:NEXT:Q(0)=1:X=80:Y=X:L=2:Z=198
180 '
190 ' ====== GAME LOOP (4 LINES) ======
200 T=STICK(0)*2:X=X+J(T):Y=Y+J(T+1):I=ZAND15:D=D(I):VPOKED,29:PUTSPRITE0,(X,Y),C
210 E=N+(Y\8)*K+X\8+K:IFI<LTHEND=D+Q(IAND1)*J(18+RND(1)*5):VPOKED,128+I:D(I)=D
218 IFI<LANDQ(DAND31)THENSCREEN0:PRINT"PTS:"P:ENDELSET=VPEEK(E)-128:C=11:Z=Z+1
