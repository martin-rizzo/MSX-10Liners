...
200 T=STICK(0)*2:X=X+J(T):Y=Y+J(T+1):I=ZAND15:D=D(I):VPOKED,7:PUTSPRITE0,(X,Y)
210 IFI<LTHEND=D+Q(IAND1)*J(18+RND(1)*5):VPOKED,C(I):D(I)=D:IFQ(DAND31)THENCLS:PRINT"PTS:";P:A$=INPUT$(1):END
215 E=N+(Y\8)*K+X\8+K:T=VPEEK(E)\4-K
220 Z=Z+1:IFT<0GOTO200ELSEVPOKEE,7:D(T)=S:L=Z\99:P=P+T:PLAY"A":LOCATE,0:PRINTP:GOTO200
