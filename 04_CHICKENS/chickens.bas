...
71 '
72 ' === INIT IMAGES (? LINES) ===
73 SPRITE$(0)="p¨øp>}½½¹8|fffî"
75 FORJ=32TO51:FORI=0TO7:T=VPEEK(176*8+I):VPOKEJ*32+I,(T\4)OR(T\2)ORT:NEXTI,J
76 FORI=1TO7:VPOKEBASE(6)+15+I,(I+3)*16+12:NEXT
80 '
