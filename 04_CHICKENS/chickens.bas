...
35 SCREEN1,2,0:KEYOFF:DEFINTA-Z:K=32:O=1280:N=6144:D=N:DIMJ(K),D(K),Q(K):PLAY"L64"
40 '
41 ' == DATA & PLAYFIELD (3 LINES) ==
42 DATA-4,4,-4,4,,4,4,,4,-4,4,-4,,-4,-4,1,1,1,32,-32,32,64,223,32,215,32,195,32
44 DATA18,32,29,512,18,32,7,32,44,2,252,1,44,1,244,12,252,8,147,2,101,1,69,1:FORI=3TO22
48 READJ(I):NEXT:FORJ=1TO16:D=D-O*(J=9):READT,U:FORI=1TOU:VPOKED,T:D=D+1:NEXTI,J
90 '
100 ' === INIT IMAGES (? LINES) ===
120 ' FORJ=32TO51:FORI=0TO7:T=VPEEK(176*8+I):VPOKEJ*32+I,(T\4)OR(T\2)ORT:NEXTI,J
125 ' SPRITE$(0)="p¨øp>}½½¹8|fffî":FORI=1040TO1048:VPOKEI,VPEEK(48+(IAND7)):NEXT
126 SPRITE$(0)="p¨øp>}½½¹8|fffî":FORI=1032TO1280:VPOKEI,VPEEK(I-8):NEXT
130 ' FORI=1TO7:VPOKEBASE(6)+15+I,(I+3)*16+12:NEXT
140 '
150 ' === INIT IMG & LOOP (? LINES) ===
170 S=N+400:FORI=0TO31:D(I)=S:Q(I)=I<5ORI>26:NEXT:Q(0)=1:L=2:X=80:Y=X:Z=L*99
180 '
