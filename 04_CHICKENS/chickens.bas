...
10 '
11 ' ====== MAIN INIT (1 LINE) ======
13 SCREEN1,2,0:COLOR,12:KEYOFF:DEFINTA-Z:N=6144:DIMJ(22),D(15),C(15):DATA100,123,32,704
14 '
15 ' === DRAW PLAYFIELD (1 LINE) ====
16 FORJ=1TO4:READD:T=J>2:FORI=1TO19-13*T:VPOKEN+D,5-13*T:D=D+32+31*T:NEXTI,J
20 '
...
32 P=P+1:I=PAND15:T=IAND1:D=D(I):VPOKED,32:T=J(18+RND(1)*5)*Q(T):IFI<LTHEND=D+T:VPOKED,C(I):D(I)=D
34 T=STICK(0)*2:X=X+J(T):Y=Y+J(T+1):PUTSPRITE0,(X,Y):D=N+(Y\8)*32+X\8+32
35 T=VPEEK(D)\4-32:IFT>=0ANDT<16THENVPOKED,32:D(T)=S:L=2+P\99:IFL>15THENL=15
36 GOTO 32
